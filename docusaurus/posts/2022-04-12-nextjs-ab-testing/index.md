...
![architecture](./00-architecture.png)
...
![at.js flowchart](./01-adobe-flowchart.png)
...
![plasmic-variants](./02-plasmic-variants.png)
...
![result-baseline](./03-result-baseline.png)
...
![result-middleware](./04-result-middleware.png)
...
![result-google-optimize](./05-result-google-optimize.png)
