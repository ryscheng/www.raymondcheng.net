...
<Head>
  <link rel="canonical" href="https://docs.oso.xyz/blog/oso-data-portal" />
</Head>

At Open Source Observer, we have been committed to building everything
in the open from the
[very beginning](../2023-11-06-open-source-open-data-open-infra.md).
...
Gitcoin Data,
and OpenRank.
This builds on the existing BigQuery public data ecosystem that includes Ethereum, Farcaster, and Lens data.
...
We have written [several guides](https://docs.oso.xyz/docs/)
...
we encourage you to
contribute back to the OSO data pipeline,
