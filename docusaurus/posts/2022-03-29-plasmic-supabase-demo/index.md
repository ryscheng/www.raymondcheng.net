...
![pokedex-screenshot](./application-screenshot-00.png)
...
![create-project-supabase](./create-project-supabase-01.png)
...
![application-screenshot](./application-screenshot-03.png)
